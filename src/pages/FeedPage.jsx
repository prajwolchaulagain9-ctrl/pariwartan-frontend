...
const AI_TAG_LABEL = 'Generated by AI';
          ...
          gap: 12, marginBottom: 24, flexWrap: 'wrap'
            ...
            <motion.button
              ...
              style={{
                ...
                background: subTab === t.key ? 'linear-gradient(135deg, #E8212A, #FF6B35)' : 'transparent',
                color: subTab === t.key ? 'white' : 'var(--text-secondary)',
                fontSize: '0.84rem', fontWeight: subTab === t.key ? 700 : 500,
                cursor: 'pointer', transition: 'all 0.2s ease',
                boxShadow: subTab === t.key ? '0 2px 8px rgba(232,33,42,0.3)' : 'none'
              }}>
          ...
          <div style={{ display: 'flex', gap: 4, background: 'var(--surface-alt)', borderRadius: 12, padding: 4, border: '1px solid var(--border)' }}>
            ...
            <motion.button
              ...
              style={{
                ...
                background: viewMode === v.key ? 'linear-gradient(135deg, #E8212A, #FF6B35)' : 'transparent',
                color: viewMode === v.key ? 'white' : 'var(--text-secondary)',
                fontSize: '0.8rem', fontWeight: viewMode === v.key ? 700 : 500,
                cursor: 'pointer', transition: 'all 0.2s ease',
                boxShadow: viewMode === v.key ? '0 2px 8px rgba(232,33,42,0.3)' : 'none'
              }}>
            ...
            >
              <div className="modal-header">
                <div>
                  <h2 className="modal-title" style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                    <Bot size={18} /> AI Suggestion Review
                  </h2>
                  <p style={{ margin: '4px 0 0', fontSize: '0.78rem', color: 'var(--text-tertiary)' }}>
                    Complaint #{aiSolutionModal.suggestion?.complaintId || 'N/A'}
                  </p>
                </div>
                <button
              ...
              <div className="modal-body">
                <div style={{ marginBottom: 12 }}>
                  <span className="ai-generated-tag">{AI_TAG_LABEL}</span>
                </div>
